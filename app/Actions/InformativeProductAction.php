...
class InformativeProductAction extends Action
{
     ...
     * @throws CustomException
     */
    public function get_by_request(Request $request, array|string $validation_role = 'get_query', array $query_addition = [], object $eloquent = null, array $relations = ['category'], array $order_by = ['id' => 'DESC']): object
    {
